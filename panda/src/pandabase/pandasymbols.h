...
#ifdef BUILDING_METALDISPLAY
  #define EXPCL_METALDISPLAY EXPORT_CLASS
  #define EXPTP_METALDISPLAY EXPORT_TEMPL
#else
  #define EXPCL_METALDISPLAY IMPORT_CLASS
  #define EXPTP_METALDISPLAY IMPORT_TEMPL
#endif
